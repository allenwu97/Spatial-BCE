...
do
    ...
    python3 make_cam.py --session_name $phase_name --data_dir $data_dir --cam_path $output_dir$phase_name'_cam' --output_dir $output_dir
    optimal_threshold=`python3 eval.py --type cam --cam_path $output_dir$phase_name'_cam' --gt_path $gt_dir
    echo $optimal_threshold
    echo ${optimal_threshold: -30: 5}
    python3 make_crf.py --data_dir $data_dir --cam_path $output_dir$phase_name'_cam' --crf_path $output_dir$phase_name'_crf' --threshold ${optimal_threshold: -30: 5}
